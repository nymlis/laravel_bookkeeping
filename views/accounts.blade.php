                ...
                <tr>
                    ...
                    <td>
                        <select name="category">
                            <option value="費用" @if (old('category') === '費用') selected @endif>費用</option>
                            <option value="収益" @if (old('category') === '収益') selected @endif>収益</option>
                            <option value="資産" @if (old('category') === '資産') selected @endif>資産</option>
                            <option value="負債" @if (old('category') === '負債') selected @endif>負債</option>
                            <option value="純資産" @if (old('category') === '純資産') selected @endif>純資産</option>
                        </select>
                    </td>
